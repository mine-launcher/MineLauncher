...
**Бесплатный лаунчер Minecraft без лицензии: все версии (26.2, 1.21.11, 26.1.2), моды, шейдеры, скины и сервера — в один клик.**
...
## Скачать MineLauncher

| Платформа | Файл | Загрузка |
|---|---|---|
| Windows 10 / 11 (64-bit) | `MineLauncher.exe` v3.1.12 | [minelauncher.me](https://minelauncher.me/api/updates/download) · [GitHub Releases](https://github.com/mine-launcher/MineLauncher/releases/latest) |
...
- **Все версии Майнкрафта** — 26.2, 1.21.11, 26.1.2, 1.21.8, 1.16.5 и все остальные
...
1. [Скачай MineLauncher](https://minelauncher.me/api/updates/download) и запусти `MineLauncher.exe`
2. Введи любой ник и выбери версию Майнкрафта (последняя — 26.2)
3. Нажми «Играть» — лаунчер сам скачает клиент игры и Java

## Безопасность

Каждый релиз перед публикацией проверяется на [VirusTotal](https://minelauncher.me/releases/virustotal.json) и Kaspersky OpenTIP. Лаунчер не собирает личные данные и не устанавливает стороннее ПО.
...
**Майнкрафт лаунчер не запускается — что делать?**
Обычно проблема в Java или повреждённых файлах. MineLauncher сам скачивает правильную Java и чистые файлы игры. Если проблема была в другом лаунчере — переключись на MineLauncher и запусти заново.

**Как установить моды на Майнкрафт?**
Выбери Fabric, NeoForge или Forge из выпадающего списка в MineLauncher, выбери версию — лаунчер сам поднимет загрузчик. Моды бери в нашем <a href="https://monitoringminecraft.com/mc-mods/">каталоге модов</a> — кнопка «Установить» поставит .jar в нужную сборку лаунчера автоматически.
...
- Мониторинг серверов: [monitoringminecraft.com](https://monitoringminecraft.com)
- Все версии лаунчера: [Releases](https://github.com/mine-launcher/MineLauncher/releases)
